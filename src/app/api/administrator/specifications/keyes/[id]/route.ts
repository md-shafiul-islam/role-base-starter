...
export async function GET(request: NextRequest, ctx: any) {
  let respUnit = getRespFormatte(null, false, esResponseMessage.notFound("Specification Key"));
...
export async function DELETE(request: NextRequest, ctx: any) {
  ...
  let respUnit = getRespFormatte(null, false, esResponseMessage.removeFailed("Specification Key"));
